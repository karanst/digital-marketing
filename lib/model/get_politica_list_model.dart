...
GetPoliticaListModel getPoliticaListModelFromJson(String str) => GetPoliticaListModel.fromJson(json.decode(str));
String getPoliticaListModelToJson(GetPoliticaListModel data) => json.encode(data.toJson());
class GetPoliticaListModel {
  GetPoliticaListModel({
      bool? status, 
      String? message, 
      List<Data>? data,}){
    _status = status;
  ...
  GetPoliticaListModel.fromJson(dynamic json) {
    _status = json['status'];
